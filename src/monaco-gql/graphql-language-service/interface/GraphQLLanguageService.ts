...
export class GraphQLLanguageService {
  ...
  async _getDefinitionForNamedType(
    ...
    const typeCastedDefs = localObjectTypeDefinitions as TypeDefinitionNode[];
  ...
  async _getDefinitionForFragmentSpread(
    ...
    const typeCastedDefs = localFragDefinitions as FragmentDefinitionNode[];
